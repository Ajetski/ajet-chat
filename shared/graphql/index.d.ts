...
> = {
	login?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationLoginArgs, 'userInfo'>
	>;
	postMessage?: Resolver<
		ResolversTypes['Message'],
		ParentType,
		ContextType,
		RequireFields<MutationPostMessageArgs, 'msgInfo'>
	>;
	register?: Resolver<
		ResolversTypes['Login'],
		ParentType,
		ContextType,
		RequireFields<MutationRegisterArgs, 'userInfo'>
	>;
};
...
> = {
	channels?: Resolver<
		...
		ParentType,
		ContextType,
		Partial<QueryChannelsArgs>
	>;
	messages?: Resolver<
		Array<ResolversTypes['Message']>,
		ParentType,
		ContextType,
		RequireFields<QueryMessagesArgs, 'channelId'>
	>;
	users?: Resolver<
